...
export default function BriefSquares() {
    return (
        <div className='flex justify-center bg-red-200 w-full flex-wrap md:flex '>
            ...
            <div className='bg-ouryellow w-full md:w-1/3 md:h-60 lg:h-60 h-72 flex items-center justify-center'>
                <div className='w-[80%] mx-auto'>
                    ...
                    <p className='text-sm'> Addressing poverty, hunger, and related challenges in underprivileged communities.</p>
